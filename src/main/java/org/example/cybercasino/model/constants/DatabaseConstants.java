...
public class DatabaseConstants {
    ...
    public static final String SELECT_WINNING_MATCHES_BY_USER = "SELECT * FROM " + GAME_HISTORY_TABLE + " WHERE " + GAME_HISTORY_TBL_USER_COL + " = ? AND " + GAME_HISTORY_TBL_AMOUNT_COL + " > 0";
    ...
    public static final String SELECT_LATEST_X_WINNING_MATCHES_BY_USER = "SELECT * FROM " + GAME_HISTORY_TABLE + " WHERE " + GAME_HISTORY_TBL_USER_COL + " = ? AND " + GAME_HISTORY_TBL_AMOUNT_COL + " > 0 ORDER BY " + GAME_HISTORY_TBL_TIME_COL + " DESC LIMIT ? OFFSET ?";
    ...
    public static final String SELECT_TRANSACTIONS_BY_USER = "SELECT * FROM " + TRANSACTION_HISTORY_TABLE + " WHERE " + TRANSACTION_HISTORY_TBL_USER_COL + " = ?";
    ...
    public static final String SELECT_LATEST_X_TRANSACTIONS_BY_USER = "SELECT * FROM " + TRANSACTION_HISTORY_TABLE + " WHERE " + TRANSACTION_HISTORY_TBL_USER_COL + " = ? ORDER BY " + TRANSACTION_HISTORY_TBL_TIME_COL + " DESC LIMIT ? OFFSET ?";
}
